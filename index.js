...
//import { PantheonJadiBot } from './plugins/jadibot-serbot.js';
...
global.db = new Low(/https?:\/\//.test(opts['db'] || '') ? new cloudDBAdapter(opts['db']) : new JSONFile('./media/database/db.json'))
...
do {
phoneNumber = await question(chalk.bgBlack(chalk.bold.greenBright(`✦ Por favor, Ingrese el número de WhatsApp.\n${chalk.bold.yellowBright(`✏  Ejemplo: +573248301921`)}\n${chalk.bold.magentaBright('---> ')}`)))
...
PantheonJadiBot({pathPantheonJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
