...
/*
browser: opcion == '1' ? ['Pantheon', 'Edge', '20.0.04'] : methodCodeQR ? ['Pantheon', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],*/
auth: {
creds: state.creds,
...
console.log('☁️ Pantheon Bot MD no tiene Sub-Bots vinculados.');
return;
}
